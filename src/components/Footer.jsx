            ...
            <div className="card">
                <div className="card-body Footer-body d-flex justify-content-center gap-5 py-4">
                    <div className=' d-flex flex-column gap-5' style={{ width: "500px" }}>
                        <Link className="navbar-brand fs-4" to="/" style={{ color: "#E6E7E9" }}>SensorSphere</Link>
                    ...
                    <div>
                        ...
                        <div className='mb-4'>
                            <img src="./assets/card_img-1.jpeg" alt="" />
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                        <div>
                            <img src="./assets/card_img-2.jpeg" alt="" />
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
                ...
                <div className="card-footer text-muted py-3 fs-6 Footer-reserved text-center">
                    ©2024.| Designed By: Jagrit Madaan(CodeMonk).| All rights reserved...
                </div>
            </div>
        </>
    )
